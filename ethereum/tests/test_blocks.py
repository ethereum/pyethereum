...
skips = {
    ...
    ('RevertDepthCreateAddressCollision.json',
     'RevertDepthCreateAddressCollision_d0g0v0_EIP158'),
    ('RevertDepthCreateAddressCollision.json',
     'RevertDepthCreateAddressCollision_d0g0v1_EIP158'),
    ('RevertDepthCreateAddressCollision.json',
     'RevertDepthCreateAddressCollision_d0g1v0_EIP158'),
    ('RevertDepthCreateAddressCollision.json',
     'RevertDepthCreateAddressCollision_d0g1v1_EIP158'),
    ('RevertDepthCreateAddressCollision.json',
     'RevertDepthCreateAddressCollision_d1g0v0_EIP158'),
    ('RevertDepthCreateAddressCollision.json',
     'RevertDepthCreateAddressCollision_d1g0v1_EIP158'),
    ('RevertDepthCreateAddressCollision.json',
     'RevertDepthCreateAddressCollision_d1g1v0_EIP158'),
    ('RevertDepthCreateAddressCollision.json',
