...
print "Code", serpent.deserialize(code3)
...
print "Code", serpent.deserialize(code4)
# important: no new genesis block
tx15 = t.Transaction.contract(5,0,10**12,1000,code4).sign(k)
addr2 = pb.apply_tx(blk,tx15)
print "Address:", addr.encode('hex')
tx16 = t.Transaction(6,10**17,10**12,1000,addr2,serpent.encode_datalist([500])).sign(k)
o = pb.apply_tx(blk,tx16)
print "First participant added", serpent.decode_datalist(o)
tx17 = t.Transaction(0,10**17,10**12,1000,addr2,serpent.encode_datalist([500])).sign(k2)
o = pb.apply_tx(blk,tx17)
print "Second participant added, USDvalue settled", serpent.decode_datalist(o)
snapshot = blk.snapshot()
tx18 = t.Transaction(7,0,10**12,1000,addr2,'').sign(k)
o = pb.apply_tx(blk,tx18)
print "Attempting to cash out immediately", o if o == -1 else serpent.decode_datalist(o)
tx19 = t.Transaction(8,0,10**12,1000,addr,serpent.encode_datalist([500,300])).sign(k)
o = pb.apply_tx(blk,tx19)
print "Changing value to 300", serpent.decode_datalist(o)
print blk.to_dict()
tx20 = t.Transaction(9,0,10**12,1000,addr2,'').sign(k)
...
tx21 = t.Transaction(7,0,10**12,1000,addr2,'').sign(k)
print "Old balances", blk.get_balance(v), blk.get_balance(v2)
