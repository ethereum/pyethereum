...
def mk_ecadd_data(p1, p2):
    ...
    if isinstance(p2[0], py_pairing.FQ):
        ...
        p2 = (p2[0].n, p2[1].n)
    return encode_int32(p1[0]) + encode_int32(p1[1]) + encode_int32(p2[0]) + encode_int32(p2[1])
...
for g in gaslimits:
    ...
    tests.append((py_pairing.multiply(py_pairing.G1, 5), py_pairing.multiply(py_pairing.G1, 9), g, 128))
    tests.append((py_pairing.multiply(py_pairing.G1, 5), py_pairing.multiply(py_pairing.G1, py_pairing.curve_order - 5), g, 192))
