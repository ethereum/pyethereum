    ...
    while 1:
        ...
        if opcode < 0x10:
            ...
            if op == 'POP':
                ...
                stk.append(utils.big_endian_to_int(ext.get_storage(msg.to, stk.pop())[:32]))
            elif op == 'SSTORE':
                s0, s1 = stk.pop(), stk.pop()
            ...
            if ext.get_storage(ETHER, msg.to) >= value and msg.depth < 1024:
